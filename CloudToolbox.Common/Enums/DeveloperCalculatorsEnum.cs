...
{
	public class DeveloperCalculatorsEnum : DeveloperEnumeration
	{

		// Area
		public static DeveloperCalculatorsEnum Binary = new(1, nameof(Binary), nameof(Binary), new() { }, null, DeveloperCalculatorType.Binary);
		public static DeveloperCalculatorsEnum Hexadecimal = new(2, nameof(Hexadecimal), nameof(Hexadecimal), new() { }, null, DeveloperCalculatorType.Hexadecimal);
